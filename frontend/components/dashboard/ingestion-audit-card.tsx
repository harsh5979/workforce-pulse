...
export function IngestionAuditCard() {
  ...
  return (
    <div className="glass-card p-6 border-border/60 bg-gradient-to-br from-card via-card to-green-950/10">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-sm font-semibold text-foreground flex items-center gap-2">
              ...
              <span className="px-2 py-0.5 text-[10px] rounded-full bg-green-500/15 text-green-400 font-mono font-medium border border-green-500/30">
                Live Audit Ready
              </span>
            </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs mb-6">
        ...
        <div className="p-3 rounded-lg bg-background/60 border border-border/40">
          ...
          <p className="font-mono text-lg font-bold text-green-400 tabular-nums">{stats.rowsActivityClean}</p>
        </div>
        <div className="p-3 rounded-lg bg-background/60 border border-border/40">
